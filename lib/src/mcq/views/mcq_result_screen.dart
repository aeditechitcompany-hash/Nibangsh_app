            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(color: AppColors.primaryBlue, fontSize: 27.5, fontWeight: FontWeight.bold),
                ),
                const SizedBox(height: 8),
                Text(
                  passed ? 'Great job! You did it.' : 'Review the topic and try this set again.',
                  textAlign: TextAlign.center,
                  style: const TextStyle(color: AppColors.textGrey, fontSize: 15.5),
                ),
                const Spacer(),
                SizedBox(

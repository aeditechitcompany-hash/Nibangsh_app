...
class AdminStepMeta {
  ...
  const AdminStepMeta({required this.id, required this.title, required this.icon, required this.color});
}
...
class ApprovalsController extends GetxController {
  ...
  void setStatusFilter(ApprovalStatusFilter filter) => selectedStatusFilter.value = filter;
}